            ...
            <div class="col">
                <div class="card widget-card bg-dark border-0 h-100 shadow-sm">
                    <div class="card-body p-4 d-flex flex-column">
                        <div class="d-flex align-items-center justify-content-center rounded-3 mb-3" style="width: 45px; height: 45px; @style(['background-color: ' . $style['bg'], 'color: ' . $style['color']])>">
